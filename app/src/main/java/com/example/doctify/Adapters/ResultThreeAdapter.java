...
public class ResultThreeAdapter extends RecyclerView.Adapter<ResultThreeAdapter.viewholder>{
    ArrayList<ResultTwoModel> list;
    Context context;

    public ResultThreeAdapter(ArrayList<ResultTwoModel> list, Context context) {
        this.list = list;
